...
![Project Architecture Diagram with Game Logic highlighted](docs/game-logic.png)

Other repos in this project:

- [Game Framework - Runners](https://github.com/threnjen/game-framework-runners)
- [Game Framework - Metadata Handler](https://github.com/threnjen/game-framework-metadata-handler)
